...
import { DynamicMessageCreator, Location } from 'express-validator/src/base';
...
export declare function checkSchema(schema: Schema, defaultLocations?: Location[]): import("express-validator/src/chain").ValidationChain[];
export {};
